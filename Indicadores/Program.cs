...
using Indicadores.Services; // Importa los servicios personalizados que se utilizarán en la aplicación.
...
if (app.Environment.IsDevelopment()) // Verifica si la aplicación está en el entorno de desarrollo.
{
    ...
    app.UseSwaggerUI(c =>
    {
        ...
        //c.RoutePrefix = string.Empty; // Hace que Swagger esté disponible en la raíz (http://localhost:5089/)
        c.RoutePrefix = "swagger"; //  Swagger estará en http://localhost:5089/swagger
    });
}
